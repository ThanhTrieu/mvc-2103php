                                ...
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <?php if($message === 'error'): ?>
                                            <h3 class="h5 text-danger mb-4"> Vui long nhap du lieu</h3>
                                        <?php endif; ?>

                                        <?php if($message === 'fail'): ?>
                                            <h3 class="h5 text-danger mb-4"> tai khoan cua ban khong dung !</h3>
                                        <?php endif; ?>

                                    </div>
                                    <form class="user" method="post" action="?c=login&m=handleLogin">
